...
$aviliablerooms = new Rooms();
$rooms_data=$aviliablerooms->selectaviliable();
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="room-text">
                            ...
                            <a href="bookroom.php ?id=<?php echo $values['room_id']?>" class="primary-btn">Book Now <i class="lnr lnr-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
