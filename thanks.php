...
<?php }
    ...
    <div class="pb-5"><?php include_once 'header_and_footer/header.php'; ?></div> 
<?php
}
?>
                    ...
                    <div class="d-flex align-items-center justify-content-center pt-5  ">
                        <div class="check-form">
                            ...
                            <form action="index.php">
                               <span> Thank you for your contact us we will help you as soon as possible</span> 
                                <br> 
                                <br> 
                                <br> 

                                <button type="submit" >go to home page <i class="lnr lnr-arrow-right"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
